...
//Por ejemplo, si el usuario ingresa 65 de peso y 1.8 de altura el programa debe imprimir en la consola la frase
...
var altura = parseInt(prompt("INGRESE SU ALTURA ACTUAL"));;
var bmi = peso / altura^2;
document.write("TU BMI ES " + bmi);
